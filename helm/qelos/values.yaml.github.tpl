...
gateway:
  image:
    repository: ghcr.io/{{ .Values.GITHUB_USERNAME }}/qelos/gateway
    tag: latest
  replicas: 2
  resources:
    requests:
...
auth:
  image:
    repository: ghcr.io/{{ .Values.GITHUB_USERNAME }}/qelos/auth
    tag: latest
  host: auth-service
  port: 9000
  replicas: 2
...
secrets:
  image:
    repository: ghcr.io/{{ .Values.GITHUB_USERNAME }}/qelos/secrets
    tag: latest
...
nocode:
  image:
    repository: ghcr.io/{{ .Values.GITHUB_USERNAME }}/qelos/no-code
    tag: latest
  replicas: 2
  host: nocode-service
  port: 9004
...
admin:
  image:
    repository: ghcr.io/{{ .Values.GITHUB_USERNAME }}/qelos/admin
    tag: latest
  replicas: 2
  host: admin-service
  port: 3001
...
plugins:
  image:
    repository: ghcr.io/{{ .Values.GITHUB_USERNAME }}/qelos/plugins
    tag: latest
  replicas: 2
...
assets:
  image:
    repository: ghcr.io/{{ .Values.GITHUB_USERNAME }}/qelos/assets
    tag: latest
  replicas: 2
  host: assets-service
  port: 9005
...
drafts:
  image:
    repository: ghcr.io/{{ .Values.GITHUB_USERNAME }}/qelos/drafts
    tag: latest
  replicas: 1
  host: drafts-service
  port: 9006
...
ai:
  image:
    repository: ghcr.io/{{ .Values.GITHUB_USERNAME }}/qelos/ai
    tag: latest
  replicas: 2
  host: ai-service
  port: 9007
